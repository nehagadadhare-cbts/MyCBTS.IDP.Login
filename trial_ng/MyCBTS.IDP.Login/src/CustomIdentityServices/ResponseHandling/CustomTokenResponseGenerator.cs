...
namespace MyCBTS.IDP.Login.CustomIdentityServices.ResponseHandling
{
    ...
    public class CustomTokenResponseGenerator : ITokenResponseGenerator
    {
        ...
        protected virtual async Task<TokenResponse> ProcessRefreshTokenRequestAsync(TokenRequestValidationResult request)
        {
            ...
            var refreshtoken = new RefreshTokenUpdateRequest
            {
            ...
            var handle = await RefreshTokenService.UpdateRefreshTokenAsync(refreshtoken);
        ...
        protected virtual async Task<(string accessToken, string refreshToken)> CreateAccessTokenAsync(ValidatedTokenRequest request)
        {
            ...
            {
                var refreshtoken = new RefreshTokenCreationRequest
                {
                    Subject = request.AuthorizationCode.Subject,
                    AccessToken = at,
                ...
                var refreshToken = await RefreshTokenService.CreateRefreshTokenAsync(refreshtoken);
